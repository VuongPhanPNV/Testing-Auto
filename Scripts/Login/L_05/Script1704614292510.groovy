...
WebUI.setText(findTestObject('Object Repository/Page_STORE/inputloginusername'), '')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/inputloginpassword'), '')
